...
write_stl(markers_border_points_world_space,   "mesh_02_border_points_w.stl", "border points")
write_stl(out_triangulation_world_space,       "mesh_03_triangulation_w.stl", "triangulation world space")
write_stl(out_triangulation_parametric_space,  "mesh_04_triangulation_p.stl", "triangulation parametric space")
write_stl(grid_triangles_parametric_space,     "mesh_05_grid_triangles_p.stl","grid parametric space")
